...
class Ui_value_changer_dialog(object):
    def setupUi(self, value_changer_dialog):
        ...
        self.param_table.setFrameShape(QtWidgets.QFrame.Shape.Panel)
        self.param_table.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.param_table.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
