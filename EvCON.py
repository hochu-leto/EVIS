...
# реальный номер 11650178014310 считывает 56118710341001 наоборот - Антон решает - по щелчку конвертировать
# решить вопрос с дробными параметрами с мультипликатором в кву
# - возможно, выдавать предупреждение при неудачном изменении
# сетку в графиках ярче - вообще нереально????
# если нет ответа от приёмника джойстика выдвавать алярму
...
# определять номер инвертора, если версия ПО выше 2212 - тоже по щелчку можно конвертировать
# галочки графиков подписать полностью
# если у графиков одинаковые имена добавлять имя блока через хештег
# если параметр удалили из избранного, также удалять его из графиков
# кнопка СБРОС должна сбрасывать 1 Курсоры, если есть, 2 сам список параметров
# добавить на графики текущее значение параметров
# при сравнении добавить возможность выбрать параметры, которые нужно взять из файла + возможность делать это программно
...
# при сохранении токов рулевых добавить информацию про номер рейки и где она установлена
