...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.power_box, 1, 1, 1, 1)
        ...
        self.spinBox = QtWidgets.QSpinBox(self.speed_box)
        font = QtGui.QFont()
        font.setFamily("Impact")
        font.setPointSize(12)
